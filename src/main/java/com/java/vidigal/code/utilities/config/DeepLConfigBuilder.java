...
/**
 * A builder class for creating {@link DeepLConfig} instances with validated configuration settings.
 * <p>
 * This class provides a fluent API to configure the DeepL API client, including API access, timeouts,
 ...
 * ensures that {@link DeepLConfig} instances are immutable and properly initialized.
 * </p>
 *
 * <h3>Usage Example:</h3>
 * <pre>{@code
 ...
 * @since 1.0
 */
public class DeepLConfigBuilder {

    /**
     * Logger for recording validation errors during configuration building.
     */
    private static final Logger logger = LoggerFactory.getLogger(DeepLConfigBuilder.class);
    /**
    ...
    /**
     * Flag indicating whether caching is enabled (default: false).
     */
    private boolean cacheEnabled = false;

    /**
     * Flag indicating whether persistent cache storage is enabled (default: false).
     */
    ...
    /**
     * Creates a new instance of {@code DeepLConfigBuilder} with default configuration values.
     * <p>
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder trackInstances(boolean trackInstances) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder retryStrategy(ExponentialBackoffStrategy retryStrategy) {
    ...
    /**
     * Sets the DeepL API endpoint URL.
     * <p>
     * This is typically the free or pro DeepL API endpoint:
     * <ul>
     *     <li>Free API: {@code https://api-free.deepl.com/v2/translate}</li>
     *     <li>Pro API: {@code https://api.deepl.com/v2/translate}</li>
     * </ul>
     * </p>
     * <p>
     * Example:
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder apiUrl(String apiUrl) {
    ...
    /**
     * Sets the authentication key for the DeepL API.
     * <p>
     * This is the API key provided by DeepL for accessing their translation services.
     ...
     * </p>
     *
     * @param authKey The authentication key; must not be null or blank.
     * @return This builder instance for method chaining.
     * @throws IllegalArgumentException if {@code authKey} is null or blank.
     * @since 1.0
     */
    public DeepLConfigBuilder authKey(String authKey) {
     ...
     * <p>
     * This timeout specifies how long to wait when establishing a connection to the DeepL API.
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder connectionTimeout(int connectionTimeout) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder socketTimeout(int socketTimeout) {
     ...
     * <p>
     * This setting controls how frequently requests can be sent to the DeepL API to avoid
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder maxRequestsPerSecond(int maxRequestsPerSecond) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder maxRetries(int maxRetries) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder rateLimitCooldown(long rateLimitCooldown) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder enableRetry(boolean retryEnabled) {
        this.retryEnabled = retryEnabled;
        return this;
    }

    /**
     * Enables or disables caching of translation responses.
     * <p>
     * When enabled, translation results are cached in memory to avoid redundant API calls for
     * identical requests, improving performance and reducing API usage.
     * </p>
     *
     * @param cacheEnabled {@code true} to enable caching; {@code false} to disable.
     * @return This builder instance for method chaining.
     * @since 1.0
     */
    public DeepLConfigBuilder enableCache(boolean cacheEnabled) {
        this.cacheEnabled = cacheEnabled;
        return this;
    }

    /**
     * Enables or disables persistent cache storage and sets the cache file path.
     * <p>
     * When enabled, the cache is persisted to disk, allowing cached translations to survive
     * application restarts. This is useful for long-running applications or maintaining cache
     * across sessions.
     * </p>
     * <p>
     * Example:
     * <pre>{@code
     * DeepLConfig config = DeepLConfig.builder()
     *     .enablePersistentCache(true, "/path/to/cache.db")
     *     .build();
     * }</pre>
     * </p>
     *
     * @param persistentCacheEnabled {@code true} to enable persistent caching; {@code false} to disable.
     * @param persistentCachePath    The file path for persistent cache storage; must not be null or blank if enabled.
     * @return This builder instance for method chaining.
     * @throws IllegalArgumentException if {@code persistentCachePath} is null or blank when {@code persistentCacheEnabled} is true.
     * @since 1.0
     */
    public DeepLConfigBuilder enablePersistentCache(boolean persistentCacheEnabled, String persistentCachePath) {
        ...
        if (persistentCacheEnabled && (persistentCachePath == null || persistentCachePath.isBlank())) {
            logger.error("Persistent cache path is null or empty");
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder closedThreadAuto(boolean closedThreadAuto) {
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder cacheTtlMillis(long cacheTtlMillis) {
     ...
     * <p>
     * This method is package-private and used internally by the {@link DeepLConfig} class
     * during construction.
     * </p>
     *
     ...
     * @since 1.0
     */
    public DeepLConfigBuilder cleanupIntervalMillis(long cleanupIntervalMillis) {
    ...
    /**
     * Builds a new {@link DeepLConfig} instance with the configured settings.
     * <p>
     ...
     * the {@link DeepLConfig} constructor.
     * </p>
     * <p>
     * Example:
     * <pre>{@code
     ...
     * </p>
     *
     * @return A new {@link DeepLConfig} instance with the current configuration.
     * @throws IllegalStateException if required configuration values (e.g., {@code apiUrl}, {@code authKey}) are not set.
     * @see DeepLConfig
     * @since 1.0
     */
    public DeepLConfig build() {
        return new DeepLConfig(this);
    }
    ...
    /**
     * Indicates whether persistent cache storage is enabled.
     * <p>
     * This method is package-private and used internally by the {@link DeepLConfig} class
     * during construction.
     * </p>
    ...
    /**
     * Returns the configured persistent cache file path.
     * <p>
     * This method is package-private and used internally by the {@link DeepLConfig} class
     * during construction.
     * </p>
     *
     * @return The persistent cache file path, or {@code null} if not set.
     * @since 1.0
     */
