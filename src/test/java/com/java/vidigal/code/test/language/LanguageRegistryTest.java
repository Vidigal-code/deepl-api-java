 ...
 * supported language codes used in the DeepL translation API. Tests cover default language support,
...
class LanguageRegistryTest {
    ...
    /**
     * Mocked {@link HttpClient} used to simulate HTTP requests to the DeepL API for fetching languages.
     */
    @Mock
    ...
    @BeforeEach
    void setUp() {
        registry = new LanguageRegistry(mockHttpClient, new ObjectMapper());
    ...
    class ApiFetchingTests {
        ...
        /**
         * Tests successful fetching and addition of new languages from the DeepL API.
         */
        @Test
        @DisplayName("should fetch and add new languages from API on success")
        void shouldFetchAndAddNewLanguages() throws Exception {
            // Arrange
            String apiResponse = "[{\"language\":\"BG\",\"name\":\"Bulgarian\"}, {\"language\":\"ET\",\"name\":\"Estonian\"}]";
            ...
            assertFalse(registry.isSupported("BG"), "Language 'BG' should not be supported initially");
            ...
            assertTrue(registry.isSupported("BG"), "Language 'BG' should be supported after API fetch");
        ...
        void shouldAllowRetryOnApiFailure() throws Exception {
            ...
            doReturn("[{\"language\":\"BG\",\"name\":\"Bulgarian\"}]").when(successResponse).body();
            ...
            assertFalse(registry.isSupported("bg"), "Language 'BG' should not be supported after failed fetch");
            ...
            assertTrue(registry.isSupported("bg"), "Language 'BG' should be supported after successful retry");
